...
08048600 <main>:
 ...
 804860f:	65 8b 15 14 00 00 00 	mov    edx,DWORD PTR gs:0x14
 ;place stack coockie
 8048616:	89 55 fc             	mov    DWORD PTR [ebp-0x4],edx
 ;initialize lvar2 as 0
 ...
 ;set second argument to 0 for memset
 8048640:	c7 40 04 00 00 00 00 	mov    DWORD PTR [eax+0x4],0x0
 ;save pointer to lvar 3 as lvar 4
